...
class Puzzle():
    ...
    def __LoadPuzzle(self, Filename):
        try:
            with open(Filename) as f:
                ...
                ##Symbols19##
                #############
                self.__TotalSymbols = self.__SymbolsLeft
                #############
                ##Symbols19##
                #############
        except:
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            if self.__SymbolsLeft < self.__TotalSymbols:
                ...
                while not Valid:
                    try:
                        undo = str(input(("Enter 'Undo' to undo last symbol, or Enter Key to skip: ")))
                        if (len(undo) == 0) or undo =='Undo':
                            Valid = True
                    except:
                        pass
                if self.__Score > 5:
    ...
    #############
    def __Undo(self):
        if not(self.__LastCell.GetSymbol() == "-"):
            self.__SymbolsLeft += 1
            CurrentCell = self.__LastCell
