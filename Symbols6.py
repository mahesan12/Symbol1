...
class Puzzle():
    def __init__(self, *args):
        if len(args) == 1:
            ...
            QPattern = Pattern("Q", "QQ**Q**QQ", False)
            self.__AllowedPatterns.append(QPattern)
            self.__AllowedSymbols.append("Q")
            ############
            ##Symbols6##
            ############
            Q180Pattern = Pattern("Q", "Q**QQQ**Q", True)
            self.__AllowedPatterns.append(Q180Pattern)
            self.__AllowedSymbols.append("Q")
            ############
            ##Symbols6##
            ############

            XPattern = Pattern("X", "X*X*X*X*X", False)
            self.__AllowedPatterns.append(XPattern)
            self.__AllowedSymbols.append("X")

            TPattern = Pattern("T", "TTT**T**T", False)
            self.__AllowedPatterns.append(TPattern)
            self.__AllowedSymbols.append("T")
            ############
            ##Symbols6##
            ############
            T180Pattern = Pattern("T", "*T**TTT*T", True)
            self.__AllowedPatterns.append(T180Pattern)
            self.__AllowedSymbols.append("T")
            ############
            ##Symbols6##
            ############
...
class Pattern():
    def __init__(self, SymbolToUse, PatternString, flip):
