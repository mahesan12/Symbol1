    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            if CurrentCell.CheckSymbolAllowed(Symbol):
                ...
                ##Symbols12##
                #############
                if len(CurrentCell.GetNotAllowed()) > 0:
                    self.__Score-=10
                    CurrentCell.RemoveNotAllowed()
                #############
                ##Symbols12##
                #############
...
class Cell():
    ...
    def RemoveNotAllowed(self):
        for count in self.__SymbolsNotAllowed:
            self.__SymbolsNotAllowed.pop()
    #############
    ##Symbols12##
    #############
