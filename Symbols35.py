...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            Valid = False
            while not Valid:
                Coordinates = input("Enter coordinates, e.g 3,4: ")
                if len(Coordinates) == 3:
                    if Coordinates[0].isnumeric():
                        if Coordinates[1] == ",":
                            if int(Coordinates[0]) >0 and int(Coordinates[0])<9:
                                if Coordinates[2].isnumeric():
                                    if int(Coordinates[2]) >0 and int(Coordinates[2])<9:
                                        Valid = True 
                                    else:
                            ...
                            print("Comma inbetween to seperate")
                    else:
