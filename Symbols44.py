        ...
        while not Finished:
            ...
            if hint == 'y':
                ...
                while not valid:
                    ...
                    if self.__GetCell(row, column).GetSymbol() == "@" or self.__GetCell(row, column).GetSymbol() == "-":
                        valid = False
                    else:
                        valid = True
                patterns = self.CheckforMatchWithPattern2(row, column)
                ...
                for each_pattern in patterns:
                    ...
                    counter+=1
                if possible:
                    print(f"Can make {nopatterns} patterns with that symbol!")
                else:
                    print(f"Cannot make a pattern with that {symbol}symbol!")
